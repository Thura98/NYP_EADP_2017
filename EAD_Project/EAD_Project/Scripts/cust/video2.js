...
var buttonGo = document.getElementById('Depart');
...
function uploadComplete(evt) {
    ...
    if (result.barcodes != null && result.barcodes.length > 0) {
        ...
        $.ajax({
            type: "POST",
            url: "VisitorManagementService.asmx/VisitorLeaveCheck",
            ...
            success: function (data) {
                if (data.d == 1) {
                    $.ajax({
                        type: "POST",
                        url: "VisitorManagementService.asmx/VisitorLeave",
                        contentType: "application/json;charset=utf-8",
                        data: JSON.stringify({ VisitorNRIC: strMsg2 }),
                        dataType: "json",
                        async: true,
                    ...
                    alert("Please scan again or approach a staff for help");
                }
            },
            error: function () {
                alert("Error");
